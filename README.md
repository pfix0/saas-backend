...
- ✅ GET /api/finance/daily — إيرادات يومية (30-90 يوم)
- ✅ GET /api/finance/transactions — معاملات + فلتر + pagination
- ✅ GET /api/finance/shipping-stats — إحصائيات الشحن
- ✅ GET /api/store/:slug/checkout-options — طرق دفع/شحن متاحة
- ✅ تحديث checkout: تكاليف شحن ديناميكية + شحن مجاني + بادئة رقم
